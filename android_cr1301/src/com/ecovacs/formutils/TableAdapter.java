...
public class TableAdapter extends BaseAdapter {  
    ...
    //public static TextView textCell =null;
        ...
        public TableRowView(Context context, TableRow tableRow) {  
            ...
            for (int i = 0; i < tableRow.getSize(); i++) {//逐个格单元添加到行  
                ...
                if (tableCell.type == TableCell.STRING) {//如果格单元是文本内容  
                    ...
                    textCell.setBackgroundColor(Color.CYAN);//背景黑色  
                    textCell.setText(String.valueOf(tableCell.value)); 
                    textCell.setTextSize(36);
                    textCell.setTextColor(android.graphics.Color.BLACK);
                    addView(textCell, layoutParams);  
                } else if (tableCell.type == TableCell.IMAGE) {//如果格单元是图像内容  
                    ImageView imgCell = new ImageView(context);  
                    imgCell.setBackgroundColor(Color.CYAN);//背景黑色  
...
//        public TableRowView TableRowColor(TableRow tableRow){
//        	
//        	return  new TableRowView(null, tableRow);	
//        }
    }  
    /** 
     * TableCell 实现表格的格单元 
